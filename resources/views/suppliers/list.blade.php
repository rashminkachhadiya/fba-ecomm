...
@section('breadcrumb')
<li class="breadcrumb-item">{{ __('Supplier List') }}</li>
@endsection
@section('content')
...
<x-lists>
    <div class="container-fluid py-5">
        ...
        <div class="row align-items-center gy-3 gx-3 position-relative">
            ...
            <div class="col-sm-auto ms-auto text-right-sm">
                <x-actions.button :url="route('suppliers.create')" class="btn btn-sm btn-primary" title="Add Supplier">
    ...
    @endphp
    {{ $dataTable->table(['id' => 'supplier-table', 'class' => 'align-middle table table-row-bordered table-row-gray-300 gs-7 gy-4 gx-7'], true) }}
...
<script>
    ...
    const updateColumnVisibilityUrl = "{{ route('supplier-columns-visibility') }}";
    const filterList = [
